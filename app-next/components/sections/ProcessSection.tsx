...
export function ProcessSection() {
  return (
    <Section className="bg-slate-50 dark:bg-slate-950/60" id="proceso">
      <Reveal>
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {homeContent.process.steps.map((step, index) => (
          <Reveal key={step.title} delay={index * 0.06}>
            <article className="rounded-md border border-slate-200 bg-brand-white p-5 shadow-soft dark:border-slate-700 dark:bg-slate-900/70">
