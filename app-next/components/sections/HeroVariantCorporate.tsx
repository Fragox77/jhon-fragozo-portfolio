...
export function HeroVariantCorporate() {
  ...
  return (
    <Section className="relative overflow-hidden border-b border-slate-200 bg-white pb-16 pt-20 dark:border-slate-700 dark:bg-slate-900 md:pt-24">
      ...
      <div className="relative grid gap-10 lg:grid-cols-12 lg:items-end">
        ...
        <Reveal className="grid gap-3 sm:grid-cols-3 lg:col-span-4 lg:grid-cols-1" delay={0.08}>
          {hero.stats.map((stat) => (
            <article key={stat.label} className="rounded-md border border-slate-200 bg-brand-white p-4 shadow-soft dark:border-slate-700 dark:bg-slate-900/70">
