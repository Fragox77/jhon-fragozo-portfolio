...
export default function ContactoError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center gap-4 px-4 text-center">
      <p className="text-body-lg font-semibold text-brand-primary">
        No se pudo cargar la página de contacto.
      </p>
      <p className="text-body text-brand-neutral">
        Puedes escribirnos directamente a{" "}
        <a href="mailto:hola@jhonfragozo.com" className="underline underline-offset-2">
          hola@jhonfragozo.com
        </a>
        .
      </p>
      <button
